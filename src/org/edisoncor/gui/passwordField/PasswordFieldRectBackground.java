...
package org.edisoncor.gui.passwordField;
 ...
 * @author Edison
 */
public class PasswordFieldRectBackground extends JPasswordField{
    ...
    public PasswordFieldRectBackground() {
        setOpaque(false);
    ...
    protected void paintComponent(Graphics g) {
        ...
        if(getText().length()<1){
            ...
            if(getText()==null)
                setText("  ");
            TextLayout layout = new TextLayout(descripcion.length()<=0? " ":descripcion,
                    getFont(),
