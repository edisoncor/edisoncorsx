 ...
 * @author EdisonCor
 */
public class TabbedSelector2 extends JTabbedPane{
    ...
    private class TabbedPaneUI extends BasicTabbedPaneUI{
        ...
        private Shape getShape(int index, int tx, int ty, int tw, int th){
            ...
            tw-=2;
            gp.moveTo(tw, ty-3);
            gp.curveTo(tw, ty-3,tw, ty,tw-3,ty);
            gp.lineTo(6, ty);
            gp.curveTo(6, ty, 3, ty, 3, ty+3);
            gp.lineTo(3, th+ty-3);
            gp.curveTo(3, th+ty-3, 3, th+ty, 6, th+ty);
            gp.lineTo(tw-3, th+ty);
            gp.curveTo(tw-3, th+ty, tw, ty+th,tw,ty+th+3);
            return gp;
        }
