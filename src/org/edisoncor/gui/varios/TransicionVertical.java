 ...
 * @author edisoncor
 */
public class TransicionVertical extends javax.swing.JPanel 
    ...
    public void addPanel(JPanel panel){
        if(paneles.isEmpty()){
            ...
            int i = paneles.size();
            this.panel.add(panel);
            panel.setBounds(0, this.panel.getHeight()*i, this.panel.getWidth(), this.panel.getHeight());
        }
        paneles.add(panel);
    }
    ...
    public void setupNextScreen() {
        ...
        for (JPanel jPanel : paneles) {
            panel.add(jPanel);
            jPanel.setBounds(0, this.panel.getHeight()*i++, this.panel.getWidth(), this.panel.getHeight());
        }
