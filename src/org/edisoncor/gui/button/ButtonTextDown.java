 ...
 * @author Edison
 */
public class ButtonTextDown extends JButton{
    ...
    public ButtonTextDown(Icon icon) {
        super(icon);
    }

    public ButtonTextDown() {
        setOpaque(false);
    ...
    private static Image loadImage(String fileName) {
        try {
            return ImageIO.read(ButtonTextDown.class.getResource(fileName));
