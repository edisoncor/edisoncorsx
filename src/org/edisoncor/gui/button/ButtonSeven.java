...
public class ButtonSeven extends JButton {
    ...
    private Color colorBrillo=new Color(0,0,0);
    ...
    public ButtonSeven(String text) {
        this();
        setText(text);
    }
    
    public ButtonSeven(Action a) {
        this();
        setAction(a);
    }
    ...
    public void setColorBrillo(Color colorBrillo) {
    ...
    public ButtonSeven() {
        ...
        buttonHighlight2 = (BufferedImage) loadImage("/resources/header-halo.png");
        ...
        buttonHighlight2 = new ColorTintFilter(colorBrillo, 1f).filter(buttonHighlight2, buttonHighlight2);
    ...
    private static Image loadImage(String fileName) {
        try {
            return ImageIO.read(ButtonSeven.class.getResource(fileName));
...
//        if (ghostValue > 0.0f) {
            ...
            g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER,
                    1));
            if(x!=null){
                g2.drawImage(buttonHighlight2,
                        x-(buttonHighlight2.getWidth()/2), 0,
                        buttonHighlight2.getWidth(), buttonHighlight2.getHeight(), null);
            }
...
//        }
        ...
        int xx = (int) (getWidth() - insets.left - insets.right -
                bounds.getWidth()) / 2;
        //x -= 2;
        ...
        layout.draw(g2,
                xx + (int) Math.ceil(shadowOffsetX),
