...
public class ButtonTask extends JButton {
    ...
    public ButtonTask(String name) {
        this(name, "Descripcion", "/resources/task-view-trip.png");
    }

    public ButtonTask(String name, String description) {
        this(name, description, "/resources/task-view-trip.png");
    }

    public ButtonTask(String name, String description, Icon icon) {
        this(name, description, "/resources/task-view-trip.png");
        setIcon(icon);
    }

    public ButtonTask(String name, Icon icon) {
        this(name, "Descripcion", "/resources/task-view-trip.png");
        setIcon(icon);
    }


   public ButtonTask(String name, String description, String imageName) {
       setText(name);
   ...
   @Override
    ...
    private static Image loadImage(String fileName) {
        try {
            return ImageIO.read(ButtonTask.class.getResource(fileName));
    ...
    private float paintText(Graphics2D g2) {
        ...
        if(modelo.isArmed()|modelo.isPressed() | !isEnabled())
