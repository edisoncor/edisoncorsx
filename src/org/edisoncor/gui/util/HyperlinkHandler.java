...
public final class HyperlinkHandler implements MouseListener, MouseMotionListener {
    ...
    public static void add(JComponent component, Rectangle bounds) {
    ...
    public static void remove(JComponent component) {
