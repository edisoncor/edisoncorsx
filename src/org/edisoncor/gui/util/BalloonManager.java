...
public class BalloonManager {
        ...
        public DropShadow(final Window parent, Shape mask) {
            ...
            parent.addComponentListener(listener = new ComponentAdapter() {
                ...
                public void componentResized(ComponentEvent e) {
                    ...
                    WindowsUtil.makeWindowsShape(DropShadow.this, getMask());
                }
                @Override
            ...
            WindowsUtil.makeWindowsShape(DropShadow.this, getMask());
            WindowsUtil.makeWindowsOpacity(DropShadow.this, SHADOW_ALPHA);
            if (parent.isVisible()) {
                pack();
                setVisible(true);
            }
    ...
    public static final class BubbleWindow extends JWindow {
        ...
        public BubbleWindow(Window owner, Component content) {
            ...
            maskSize = getSize();
            WindowsUtil.makeWindowsShape(BubbleWindow.this, mask);
