...
import org.edisoncor.gui.util.BrightPassFilter;
import org.edisoncor.gui.util.GraphicsUtilities;


public class PanelGlassBright extends JComponent {
    ...
    public void setVisible(boolean visible) {
        if (visible) {
                ...
                backDrop = new BrightPassFilter(mixValue).filter(backDrop, null);
